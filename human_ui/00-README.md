...
- `app.js` — browser state, management API calls, navigation, and rendering.

The UI is a client of the outer management API; provider credentials and catalog parsing stay server-side.
